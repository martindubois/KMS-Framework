...
static const KMS::Cfg::MetaData MD_SAVE                 ("Save = {Path}");
...
namespace KMS
{
    namespace Cfg
    {
        ...
        Configurator::Configurator() : mIgnoredCount(0)
        {
            ...
            mSave               .mOnChanged.Set(this, ON_SAVE_CHANGED);
            ...
            mDictionary.AddEntry("Save"               , &mSave               , false, &MD_SAVE);
