...
namespace KMS
{
    namespace Msg
    {
        ...
        // Actions
        const unsigned int IReceiver::MSG_ACTION_CLEAR        = 0x01000000;
        const unsigned int IReceiver::MSG_ACTION_QUEUE        = 0x02000000;
        const unsigned int IReceiver::MSG_ACTION_STOP         = 0x04000000;

        // Groups
        const unsigned int IReceiver::MSG_ERRORS              = 0x0000ffff;
        const unsigned int IReceiver::MSG_ERRORS_AND_WARNINGS = 0x00ffffff;
