...
namespace KMS
{
    namespace Text
    {
        ...
        void WritePtr::operator += (unsigned int aInc)
        {
            ...
            KMS_EXCEPTION_ASSERT(mIndex_byte + aInc + 2 <= mSize_byte, OUTPUT_TOO_SHORT, "The output buffer is too short");
        ...
        void WritePtr::Write(char aIn)
        {
            ...
            KMS_EXCEPTION_ASSERT(mIndex_byte + 1 + 2 <= mSize_byte, OUTPUT_TOO_SHORT, "The output buffer is too short");
        ...
        void WritePtr::Write(const char* aIn, unsigned int aInSize_byte)
        {
            ...
            KMS_EXCEPTION_ASSERT(mIndex_byte + aInSize_byte + 2 <= mSize_byte, OUTPUT_TOO_SHORT, "The output buffer is too short");
