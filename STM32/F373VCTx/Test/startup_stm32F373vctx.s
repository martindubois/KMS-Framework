# 1 "../../Startup/startup_stm32F373vctx.s"
# 1 "C:/_VC/KMS-Framework/STM32/F373CVTx/Test//"
# 1 "<built-in>"
#define __STDC__ 1
...
#define _KMS_EMBEDDED_ 1
#define STM32 1
#define STM32F3 1
#define STM32F373xC 1
#define STM32F373VCTx 1
#define DEBUG 1
# 1 "../../Startup/startup_stm32F373vctx.s"
# 25 "../../Startup/startup_stm32F373vctx.s"
.syntax unified
.cpu cortex-m4
.fpu softvfp
.thumb
...
.word _ebss
# 54 "../../Startup/startup_stm32F373vctx.s"
...
# 112 "../../Startup/startup_stm32F373vctx.s"
  .section .text.Default_Handler,"ax",%progbits
Default_Handler:
Infinite_Loop:
  b Infinite_Loop
  .size Default_Handler, .-Default_Handler
# 125 "../../Startup/startup_stm32F373vctx.s"
...
g_pfnVectors:
  ...
  .word CAN_RXD_IRQHandler
  .word CAN_RXI_IRQHandler
  .word CAN_SCE_IRQHandler
  .word EXTI5_9_IRQHandler
  .word TIM15_IRQHandler
  .word TIM16_IRQHandler
  .word TIM17_IRQHandler
  .word TIM18_DAC_IRQHandler
  ...
  .word 0
  .word FPU_IRQHandler
# 237 "../../Startup/startup_stm32F373vctx.s"
 .weak NMI_Handler
