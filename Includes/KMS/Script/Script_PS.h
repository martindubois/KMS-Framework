...
/// \file      Includes/KMS/Script/Script_PS.h
...
namespace KMS
{
    namespace Script
    {
        ...
        /// \brief Class used to generate power shell script
        class Script_PS final : public Script
        {
        ...
        public:
            ...
            Script_PS(const char* aFileName);

            // ===== Script =================================================
            virtual ~Script_PS() override;
            virtual void Write_Comment(const char* aComment)override;
            virtual void Write_Echo(const std::string&, unsigned int aFlags = 0) override;
        ...
        protected:
            ...
            virtual void Indent_Inc() override;
